...
项目线上演示地址：[https://xiol-liang.github.io/covid19](http://xiol-liang.github.io/covid19)
...
- 报错：`Mixed Content: The page at 'https://xiol-liang.github.io/covid19/#/' was loaded over HTTPS, but requested an insecure XMLHttpRequest endpoint 'http://iwenwiki.com/wapicovid19/all.php'. This request has been blocked; the content must be served over HTTPS.` HTTPS 页面里动态的引入 HTTP 资源,比如引入一个 js 文件,会被直接 block 掉的。部署 Github Pages 时,手机端能正常显示数据，电脑端由于跨域问题数据不能正常显示
